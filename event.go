...
//
// If Stack() has been called before and logger.ErrorStackMarshaler is defined,
// the err is passed to ErrorStackMarshaler and the result is appended to the
// logger.ErrorStackFieldName.
...
// To customize the key name, change logger.TimestampFieldName.
//
...
// Dur adds the field key with duration d stored as logger.DurationFieldUnit.
// If logger.DurationFieldInteger is true, durations are rendered as integer
// instead of float.
...
// Durs adds the field key with duration d stored as logger.DurationFieldUnit.
// If logger.DurationFieldInteger is true, durations are rendered as integer
// instead of float.
